        ...
        <div class="col-12">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr style="font-size: 10px;">
                    ...
                    <td class="d-flex">  
                        <div class="">
                            <a href="{{ route('charges-edit', ['id' => $client->id ]) }}" class="btn btn-warning btn-sm">
                        ...
                        <div class="">
                            ...
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger btn-sm ms-3" onclick="return confirm('Só excluia essa cobrança se realmente a dívida estiver quitada.')">
