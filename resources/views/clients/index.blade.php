        ...
        <div class="col-12">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr style="font-size: 10px;">
                    ...
                    <td class="d-flex">  
                        <a href="{{ route('clients-edit', ['id' => $client->id ]) }}" class="btn btn-warning btn-sm ms-3">
                        ...
                        <form action="{{ route('clients-delete', ['id' => $client->id]) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger btn-sm ms-3" onclick="return confirm('Tem certeza que deseja excluir este livro?')">
